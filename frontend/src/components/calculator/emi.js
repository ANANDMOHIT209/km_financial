    ...
    <Container maxWidth="md">
      <form onSubmit={handleSubmit}>
        <Grid container spacing={4} sx={{ padding: "20px", margin: "20px", backgroundColor: "#f0f0f0" }}>
          <Grid item xs={12}>
            <Typography variant="h5">Loan Calculator</Typography>
          </Grid>
          <Grid item xs={12}>
            <TextField
              type="number"
        ...
        <Grid container spacing={4}>
          <Grid item xs={6}>
            <Box sx={{ padding: "20px", margin: "20px"}}>
              ...
              <Typography>Monthly Payment: {calculationResult.principal}</Typography>
              <Typography>Total Repayment: {calculationResult.interest}</Typography>
              <Typography>Monthly Payment: {calculationResult.monthly_payment}</Typography>
              <Typography>Total Repayment: {calculationResult.total_repayment}</Typography>
            </Box>
          </Grid>
          <Grid item xs={6}>
            <Box sx={{ padding: "20px", margin: "20px"}}>
